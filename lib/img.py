...
def import_img_to_ncbi_table():
  ...
  df_img_to_ncbi_all_trim = df_img_to_ncbi_all[["IMG_ID_taxon_oid","Domain","Phylum","Class","Order","Family","Genus","Species","Strain","IMG_Cluster_ID", "IMG_Release_Pipeline_Version","NCBI_Taxon_ID"]]
  ...
  # keep only columns required for taxonomy linking
  df_img_to_ncbi_all_trim_merge_trim = df_img_to_ncbi_all_trim_merge[["IMG_ID_taxon_oid","IMG_taxonomy_clean","Strain","IMG_Cluster_ID", "IMG_Release_Pipeline_Version","NCBI_Taxon_ID"]]
